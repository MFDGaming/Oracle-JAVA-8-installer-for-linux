...
tar -C /opt -zxvf jdk-8u201-linux-arm32-vfp-hflt.tar.gz

rm jdk-8u201-linux-arm32-vfp-hflt.tar.gz

update-alternatives --install /usr/bin/java java /opt/jdk1.8.0_201/jre/bin/java 2000 

echo "/opt/jdk1.8.0_201/jre/lib/arm/jli" | tee -a /etc/ld.so.conf
...
ldconfig
	...
	*)
	 ...
	 echo $"Usage: $0 {arm | arm64 | x86 | x64}"
